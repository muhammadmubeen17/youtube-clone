        ...
        <nav className='py-2 fixed top-0 left-0 right-0 bg-white z-50'>
            <ul className='px-2.5 list-none flex justify-between'>
                <li className='flex flex-row justify-center '>
                    ...
                    <div className='flex justify-center w-[120px] px-4 after:content-["pk"] relative after:absolute after:top-1.5 after:-right-0.5 after:text-black after:uppercase text-xs'>
