...
function SidebarExpand() {
    ...
    return (
        <div id='expanded_sidebar' className='w-[240px] z-40 h-[91.2vh] fixed top-14 pt-3 pb-4 left-0 right-0 bg-white overflow-y-scroll overflow-hidden hidden md:block'>
