...
const Filterbar = (props) => {
    ...
    if (props.sidebarstate == "expand") {
        filterPaddingLeft = "pl-[90px]";
    } else {
        filterPaddingLeft = "pl-[260px]";
    }

    return (
        <div id='filterbar' className={"w-full py-3 pr-2 fixed left-0 right-0 whitespace-nowrap bg-white overflow-x-scroll z-30 " + filterPaddingLeft}>
